...
const Academy = () => {
  ...
  if (!level) {
    const localizedLevels = [
      { key: "newbie", title: t("academy.levels.newbie.title"), emoji: "🌱", desc: t("academy.levels.newbie.desc"), lessons: 20, time: t("academy.levels.newbie.time"), popular: true },
      { key: "ai-user", title: t("academy.levels.aiUser.title"), emoji: "🤖", desc: t("academy.levels.aiUser.desc"), lessons: 12, time: t("academy.levels.aiUser.time"), popular: false },
      { key: "web3", title: t("academy.levels.web3.title"), emoji: "⚡", desc: t("academy.levels.web3.desc"), lessons: 8, time: t("academy.levels.web3.time"), popular: false },
    ];
    return (
      <div className="min-h-screen bg-background">
        <SEOHead title={t("academy.seoTitle")} description={t("academy.seoDesc")} />
        <Navbar />
          ...
          <div className="relative overflow-hidden rounded-3xl border border-purple-500/20 bg-gradient-to-br from-purple-950/40 via-violet-900/20 to-background p-8 md:p-12 mb-10 text-center">
            ...
            <div className="relative">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/30 text-xs text-purple-300 mb-4">
                <Sparkles className="w-3 h-3" /> {t("academy.heroBadge")}
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 max-w-2xl mx-auto mb-8">
                <div className="rounded-xl bg-white/5 border border-white/10 p-4">
                  ...
                  <div className="text-xs text-gray-400 mt-1">{t("academy.stats.students")}</div>
                </div>
                <div className="rounded-xl bg-white/5 border border-white/10 p-4">
                  <div className="text-2xl md:text-3xl font-bold text-emerald-400">92%</div>
                  <div className="text-xs text-gray-400 mt-1">{t("academy.stats.completion")}</div>
                </div>
                <div className="rounded-xl bg-white/5 border border-white/10 p-4">
                  <div className="text-2xl md:text-3xl font-bold text-amber-400">1,775</div>
                  <div className="text-xs text-gray-400 mt-1">{t("academy.stats.earned")}</div>
                </div>
              </div>
              <Button
                size="lg"
              ...
              <p className="text-xs text-gray-400 mt-3">{t("academy.ctaSub")}</p>
            </div>
          </div>

          {/* Level picker */}
          <div id="level-picker" className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">{t("academy.chooseLevel")}</h2>
            <p className="text-gray-400">{t("academy.chooseLevelSub")}</p>
          </div>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2 pt-2">
                    <Badge variant="secondary" className="bg-purple-500/15 text-purple-200 border border-purple-500/30">
                      <BookOpen className="w-3 h-3 mr-1" /> {l.lessons} {t("academy.lessons")}
                    </Badge>
