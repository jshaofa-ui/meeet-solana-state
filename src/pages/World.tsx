...
const FACTIONS = [
  { key: "ai", label: "ИИ ЯДРО", icon: "🤖", classes: ["trader", "diplomat", "builder", "hacker"], color: "#3B82F6", hsl: "217,91%,60%", region: "Neural Network",
    ministries: [
      { slug: "ai-architects", name: "AI Architects", icon: "🤖" },
      { slug: "politics-diplomacy", name: "Politics & Diplomacy", icon: "⚖️" },
    ] },
  { key: "biotech", label: "БИОТЕХ", icon: "🧬", classes: ["oracle"], color: "#22C55E", hsl: "142,71%,45%", region: "Genome Lab",
    ministries: [
      { slug: "health-bio", name: "Health & Bio", icon: "🧬" },
      { slug: "climate-earth", name: "Climate & Earth", icon: "🌍" },
    ] },
  { key: "energy", label: "ЭНЕРГИЯ", icon: "⚡", classes: ["miner"], color: "#F59E0B", hsl: "38,92%,50%", region: "Power Grid",
    ministries: [
      { slug: "energy-resources", name: "Energy & Resources", icon: "⚡" },
      { slug: "trade-logistics", name: "Trade & Logistics", icon: "📦" },
    ] },
  { key: "space", label: "КОСМОС", icon: "🚀", classes: ["warrior", "scout"], color: "#06B6D4", hsl: "189,94%,43%", region: "Launch Pad",
    ministries: [
      { slug: "space-cosmos", name: "Space & Cosmos", icon: "🚀" },
      { slug: "media-journalism", name: "Media & Journalism", icon: "📰" },
    ] },
  { key: "quantum", label: "КВАНТУМ", icon: "⚛️", classes: ["banker"], color: "#A855F7", hsl: "271,91%,65%", region: "Qubit Array",
    ministries: [
